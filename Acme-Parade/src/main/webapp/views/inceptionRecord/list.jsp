...
<display:table name="inceptionRecords" id="row" requestURI="${requestURI}" pagesize="5" class="displaytag">

	<security:authorize access="hasRole('BROTHERHOOD')">
		<display:column>
			<a href="inceptionRecord/brotherhood/edit.do?inceptionRecordId=${row.id}">
			<spring:message code="inceptionRecord.edit" /></a>
		</display:column>
	</security:authorize>
	...
	<security:authorize access="hasRole('BROTHERHOOD')">
		<display:column titleKey="inceptionRecord.delete">
			<a href="inceptionRecord/brotherhood/delete.do?inceptionRecordId=${row.id}"><spring:message code="inceptionRecord.delete" /></a>
		</display:column>
	</security:authorize>
...
<security:authorize access="hasRole('BROTHERHOOD')">
	<div> <a href="inceptionRecord/brotherhood/create.do?historyId=${historyId}"> 
